...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLL3.PLL3M = 23;
    ...
    PF11     ------> ADC1_INP2
    */
    GPIO_InitStruct.Pin = TP_111_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(TP_111_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = M_Supply_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(M_Supply_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = U_current_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(U_current_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(TP_111_GPIO_Port, TP_111_Pin);

    HAL_GPIO_DeInit(M_Supply_GPIO_Port, M_Supply_Pin);

    HAL_GPIO_DeInit(U_current_GPIO_Port, U_current_Pin);
